...
import com.michael.mystoryapplication.util.DataDummy
import com.michael.mystoryapplication.util.MainDispatcherRule
import com.michael.mystoryapplication.util.getOrAwaitValue
...
class ListViewModelTest{
    ...
    fun `when Get Story Should Not Null and Return Data`() = runTest {
        ...
        val actualStory: PagingData<ListStoryItem> = listViewModel.story.getOrAwaitValue()
    ...
    fun `when Get Story Empty Should Return No Data`() = runTest {
        ...
        expectedStory.value = data
        Mockito.`when`(storyRepository.getStory()).thenReturn(expectedStory)
        val mainViewModel = ListViewModel(storyRepository)
